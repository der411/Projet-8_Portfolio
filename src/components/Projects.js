      ...
      <section id="projects" className="text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-5 mb-20">
          {projectsData.map((project) => (
            ...
            >
              <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center transition-all duration-300 hover:bg-opacity-60">
              <span className="text-white text-lg font-bold opacity-0 transition-opacity ease-in duration-150 hover:opacity-100">
                  → Voir plus
                </span>
              </div>
