  ...
  return (
    ...
    >
      <div className="relative">
        <button className="absolute top-2.5 right-3.5 text-black dark:text-white text-2xl cursor-pointer" aria-label="Fermer la modale" onClick={onRequestClose}>
        ...
        <p className="mb-4 text-[14px] md:text-[16px] sm:text-[15px]">{project.development}</p>
          ...
          {project.githubLink && (
            <p className="mb-4">
              <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="ml-1" aria-label="Voir le dépot GitHub">
